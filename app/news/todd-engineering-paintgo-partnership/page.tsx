  ...
  return (
    <>
      ...
      <div className="art-body rv">
        ...
        <p className="art-p">PaintGo is a pioneering robotics company specialising in AI-driven spray finishing systems for the automotive refinishing industry. Their flagship robot, the <strong>PG-90E</strong>, is a seven-axis industrial spray robot purpose-built for bodyshop environments — compatible with SATA, IWATA and 3M systems, supporting waterborne and 2K materials, and designed to deliver a consistent, high-quality finish on every single panel.</p>
