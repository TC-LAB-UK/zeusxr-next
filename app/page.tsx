        ...
        <div className="w-1300">
          ...
          <div className="proj-grid">
            {caseStudies.length > 0 ? caseStudies.map((cs: any, i: number) => (
              ...
              <>
                <Link href="/projects/british-wind-farm" className="proj-card rv">
                ...
                <Link href="/projects/dubai-aerospace" className="proj-card rv d1">
                ...
                <Link href="/projects/amalgam" className="proj-card rv d2">
                  <div className="proj-bg" style={{ background: 'var(--s2)' }}></div>
                  <div className="proj-overlay">
