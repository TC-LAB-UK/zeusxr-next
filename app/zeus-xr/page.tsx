...
export const metadata: Metadata = {
  ...
  description: 'Zeus XR is an AI-assisted robotic spray booth system that delivers consistent, automated spray finishing for modern bodyshops. Up to a 30% increase in throughput, 50% less rework.',
  openGraph: {
