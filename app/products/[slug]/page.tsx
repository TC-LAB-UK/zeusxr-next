...
// ── Energy Calculator (inlined to avoid import resolution issues) ──────────
    ...
    <section className="calc-sec">
      <div className="calc-inner">
        ...
        <div className="calc-card">
          ...
          <p className="calc-note">Based on 25,000m³/hr AHP · {annual} annual cycles ({cycles}/week × 48 weeks) · CO₂ factors: gas 0.183 kg/kWh, UK grid 0.233 kg/kWh</p>
        </div>
      </div>
    </section>
  )
