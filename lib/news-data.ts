...
export const NEWS_DATA: Record<string, NewsArticle> = {
  ...
  'mem-magazine-made-in-britain': {
    ...
    category: 'Press',
    date: 'April 2025',
    thumb: '/media/made-in-britain.jpg',
    hero: '/media/zeus-xr-32.jpg',
  ...
  'night-of-knights-award-2024': {
    ...
    body: [
      ...
      { type: 'img', text: '', src: '/media/zeus-xr-32.jpg', caption: 'Todd Engineering collecting the Spray Booth Manufacturer of the Year 2024 award at the Night of Knights.' },
    ],
  },
  ...
  'al-haddad-motors-bahrain': {
    ...
    date: 'February 2025',
    thumb: '/media/projects/al-haddad-motors/hero.jpg',
  ...
  'mg-carbon-neutral-partnership': {
    ...
    date: 'November 2024',
    thumb: '/media/made-in-britain.jpg',
    hero: '/media/made-in-britain.jpg',
